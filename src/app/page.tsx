    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 flex flex-col justify-center items-center px-4">
        <div className="text-center">
          ...
          <h1 className="text-3xl font-bold text-gray-800 mb-2">Welcome to Covid-19 Patient Hub</h1>
          <p className="text-xl text-gray-600 mb-8">Please sign in to access the patient management system</p>
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          ...
          <h1 className="text-3xl font-bold text-gray-800 mb-2">Patient Management System</h1>
          <p className="text-xl text-gray-600">Manage your Patient efficiently</p>
        </div>
        <PatientList />
      </div>
    </div>
