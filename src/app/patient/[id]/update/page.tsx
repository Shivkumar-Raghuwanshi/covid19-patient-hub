...
// Main component that renders the Update Patient page
export default function UpdatePatientPage({ params }: { params: { id: string } }) {
 ...
 // Render the Update Patient page
 return (
   <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 py-12 px-4 sm:px-6 lg:px-8">
     <Card className="w-full max-w-4xl mx-auto mt-8 shadow-lg rounded-lg overflow-hidden bg-white border border-gray-200">
       <CardHeader className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white p-6">
         <CardTitle className="text-2xl font-semibold flex items-center justify-between">
           <div className="flex items-center">
             <User className="mr-3 h-6 w-6" /> Update Patient
           </div>
           <Button
             variant="outline"
             size="sm"
 ...
 return (
   <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 flex justify-center items-center px-4">
     <Card className="w-full max-w-md shadow-lg rounded-lg overflow-hidden bg-white border border-gray-200">
       ...
       <CardContent className="p-6">
         <p className="text-gray-600 mb-4">Please sign in to update a patient.</p>
